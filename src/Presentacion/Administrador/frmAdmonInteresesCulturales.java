 ...
 * @author alina
 */
public class frmAdmonInteresesCulturales extends javax.swing.JFrame {


    public frmAdmonInteresesCulturales() {
        initComponents();
   ...
   //     this.getContentPane().setBackground(Color.WHITE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAdmonInteresesCulturales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmAdmonInteresesCulturales().setVisible(true);
            }
        });
    }
